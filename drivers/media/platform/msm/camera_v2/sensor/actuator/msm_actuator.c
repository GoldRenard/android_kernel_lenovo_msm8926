...
/* + add for vcm 657(4) & 658(0) */
extern struct otp_struct current_otp;
extern struct otp_struct_ov8865 ov8865_current_otp;
/* + end */
...
/* + add for vcm 657(otp 4) & 658(otp 0) */
		if ((current_otp.user_data[0] == 4)||(ov8865_current_otp.user_data[0] == 4))//vcm 657 for 1st MP use
		    cdata->cfg.cam_name = 6;
        else
            cdata->cfg.cam_name = 4;//vcm 658 for mix
/* + end */
